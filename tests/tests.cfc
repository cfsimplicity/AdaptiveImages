...
void function beforeTests(){
	variables.imageFolderUrl	=	"/adaptiveimages/tests/images/";
...
/* Tests */
public void function init_throwsException_ifNoResolutionsDefined(){
	expectException( "AdaptiveImages.invalidConfiguration" );
	variables.ai	=	New root.adaptiveImages( [] );
}

public void function init_throwsException_ifBrowserCacheSecondsIsNotAnInteger(){
	expectException( "AdaptiveImages.invalidConfiguration" );
	variables.ai	=	New root.adaptiveImages( resolutions=[ "480" ],browserCacheSeconds=5.1 );
}

public void function init_throwsException_ifPixelDensityMultiplierIsInvalid(){
	expectException( "AdaptiveImages.invalidConfiguration" );
	variables.ai	=	New root.adaptiveImages( resolutions=[ "480" ],pixelDensityMultiplier=0 );
}

public void function init_throwsException_ifJpegQualityIsInvalid(){
	expectException( "AdaptiveImages.invalidConfiguration" );
	variables.ai	=	New root.adaptiveImages( resolutions=[ "480" ],jpgQuality=0 );
}

public void function init_sortsResolutions_smallestFirst(){
...
public void function getSourceFilePath_returnsPath_romAValidSourceImageUrl(){
...
public void function getSourceFilePath_cachesPath_byDefault(){
	makePublic( ai,"getSourceFilePath" );
...
public void function mimeType_handlesGifJpegAndPng(){
...
public void function mimeType_throwsException_onInvalidFileExtension(){
	expectException( "AdaptiveImages.invalidFileExtension" );
	makePublic( ai,"mimeType" );
	ai.mimeType( ".doc" );
}

public void function isMobile_findsMobile_anywhereInString(){
...
public void function cookieIsValid_works(){
...
public void function deleteCookie_works(){
...
public void function defaultResolution_returnsSmallest_forMobile(){
...
public void function defaultResolution_returnsLargest_forNonMobile(){
	makePublic( ai,"defaultResolution" );
...
public void function resolution_returnsRetinaResolution_exceedingLargestDefined(){
...
public void function resolution_returnsRetinaResolution_atOrBelowLargestDefined(){
...
public void function resolution_returnsNonRetinaResolution_exceedingLargestDefined(){
	makePublic( ai,"resolution" );
	setResolutionCookie( "500,1" );//non-retina
	Assert( ai.resolution() EQ 500 );// client width is bigger than largest defined
}

public void function resolution_returnsNonRetinaResolution_atOrBelowLargestDefined(){
	makePublic( ai,"resolution" );
	setResolutionCookie( "300,1" );
	Assert( ai.resolution() EQ 320 );
}

public void function process_sendsSourceImage_ifResolutionExceedsLargestDefined(){
	injectMethod( ai,this,"sendImage" );
	setResolutionCookie( "500,1" );
	Assert( ai.process( sourceImageUrl ) IS sourceImagePath );
}

public void function cachedFileExists_detectsAndCachesCachedFileExistence(){
...
public void function process_sendsCachedImage_ifItExists(){
	injectMethod( ai,this,"sendImage" );
...
public void function process_sendsSourceImage_ifResolutionExceedsSourceWidth(){
	injectMethod( ai,this,"sendImage" );
...
public void function generateImage_resizes_toSpecifiedWidth(){
...
public void function ensureCacheFolderExists_createsCacheFolderAndCachesPath(){
...
public void function checkCachedImageIsNotLargerThanSource_cachesCopyOfSource_ifResizedImageIsLarger(){
...
public void function process_cachesAndSendsImageSizedToResolution_ifNotInCache(){
	injectMethod( ai,this,"sendImage" );
	var cacheFolderPath	=	imageFolderPath & 320 & "/";
